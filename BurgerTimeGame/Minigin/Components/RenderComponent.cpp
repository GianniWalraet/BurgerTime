...
void RenderComponent::Render()
{
	...
	if(m_pSprite)
	{
		...
		renderer.RenderTexture(*m_pSprite->GetTexture().get(), static_cast<int>(pos.x), static_cast<int>(pos.y), m_pSprite->GetDstWidth(), m_pSprite->GetDstHeight(), m_pSprite->GetCurrentFrame(), m_pSprite->GetIsMirrored());
	}
}
